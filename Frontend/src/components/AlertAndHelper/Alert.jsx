...
const Alert = ({ type = "info", message, visible, setVisible }) => {
  const alertClasses = ALERT_COLORS[type] || ALERT_COLORS.info;
  ...
  return (
    <div
      ...
      role="alert"
    >
      <div className={`flex items-center p-4 mb-4 border-t-4 ${alertClasses} rounded-lg shadow-lg`}>
