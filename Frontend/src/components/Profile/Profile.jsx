                ...
                <div className="flex items-start gap-4 p-4 rounded-lg bg-gray-700/30 hover:bg-gray-700/50 transition-colors">
                  <div className="p-2 bg-gaming-cyan/20 rounded-lg">
                    <svg className="w-6 h-6 text-gaming-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A1 1 0 016 17h12a1 1 0 01.879.516M15 11a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                  </div>
                  <div className="flex-1">
                    <p className="text-sm text-gray-400">Account Role</p>
                    <p className="text-lg text-white font-medium">{profileData.role}</p>
                  </div>
                </div>
              </div>
            </div>
